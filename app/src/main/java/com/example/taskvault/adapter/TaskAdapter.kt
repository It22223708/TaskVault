...
import com.example.taskvault.databinding.TaskLayoutBinding
import com.example.taskvault.fragments.HomeFragmentDirections
...
class TaskAdapter:RecyclerView.Adapter<TaskAdapter.TaskViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val direction = HomeFragmentDirections.actionHomeFragment2ToEditTaskFragment2(currentTask)
